<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    	...
    	<div class="block mb-8 ">
    		<a href="{{route('tasks.create')}}" class="px-4 py-2 border-gray items-center bg-green-400 hover:bg-green-900 text-white mb-2">Add Task</a>
    	</div>
   						...
   						<table class="min-w-full divide-y divide-gray-200">
   							...
   							<tbody class="bg-white divide-y divide-gray-200">
   								...
   								<tr>
   									...
   									<form class="inline-block" method="POST" action="{{ route('tasks.destroy',$task->id)}}">
